...
public class TransferReportActivity extends MainActivity {
    ProgressDialog pDialog;
    int success;

    private static final String TAG = TransferReportActivity.class.getSimpleName();
     ...
     */
    private TransferReportActivity.SectionsPagerAdapter mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setDinamicContent(R.layout.app_bar_transfer_report);
        buildMenu();
    ...
    public static class TabFragment1 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            return inflater.inflate(R.layout.tab_fragment_t_detail_1, container, false);
        }
    }
    ...
    public static class TabFragment2 extends Fragment {
        ...
        @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            return inflater.inflate(R.layout.tab_fragment_t_detail_2, container, false);
        }
    }
    ...
    private void set_detail_issue(String issue_number) {
        ...
        _string_request(
                Request.Method.GET,
                Server.URL + "transfer/detail?api-key=" + Server.API_KEY,
                params, true,
                new VolleyCallback() {
                    @Override
                    public void onSuccess(String result) {
                        hideDialog();
                        Log.e(TAG, "Detail result : "+ result.toString());
                        try {
                            ...
                            if (success == 1) {
                                ...
                                txt_po_number.setText(data.getString("ti_number"));
                                TextView txt_origin_name = (TextView) findViewById(R.id.txt_origin_name);
                                txt_origin_name.setText(data.getString("warehouse_from_name"));
                                ...
                                ArrayAdapter adapter = new ArrayAdapter<String>(TransferReportActivity.this, R.layout.activity_list_view, po_items);
                                ...
                                CustomListAdapter adapter2 = new CustomListAdapter(TransferReportActivity.this, list_timeline_ids, list_timeline_titles, list_timeline_descs, R.layout.list_view_timeline);
